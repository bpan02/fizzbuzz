...
describe FizzBuzz do
  describe '.fizz_buzzify' do
    ...
    context "given a '1'" do
      it 'returns 1' do
        expect(fizzbuzz.fizz_buzzify(1)).to eql('1')
      end
    end

    context "given a '5'" do
      it 'returns Fizz' do
        expect(fizzbuzz.fizz_buzzify(5)).to eql('FizzFizz')
      end
    end

    context "given a '2'" do
      it 'returns 2' do
        expect(fizzbuzz.fizz_buzzify(2)).to eql('2')
      end
    end

    context "given a '46'" do
      it 'returns 46' do
        expect(fizzbuzz.fizz_buzzify(46)).to eql('46')
      end
    end

    context "given a '47'" do
      it 'returns Buzz' do
        expect(fizzbuzz.fizz_buzzify(47)).to eql('Buzz')
      end
    end

    context "given a '49'" do
      it 'returns BuzzBuzz' do
        expect(fizzbuzz.fizz_buzzify(49)).to eql('BuzzBuzz')
      end
    end

    context "given a '50'" do
      it 'returns FizzFizzFizz' do
        expect(fizzbuzz.fizz_buzzify(50)).to eql('FizzFizzFizz')
      end
    end
  end
